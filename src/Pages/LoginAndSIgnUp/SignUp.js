...
const SignUp = () => {
    ...
    const handleSignUp = () => {
        setError('')
        if (!/(?=.*[A-Z])/.test(name)) {
            return setError('Please Provide Capital Letter on Name')
        }
            ...
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <div className="card-body">
                    ...
                    <div className="form-control">
                        ...
                        <input onBlur={(e) => setName(e.target.value)} type="text" name='name' placeholder="full name" className="input input-bordered" />
                    </div>
                    <div className="form-control">
                        <label className="label">
                    ...
                    <p className='text-sm text-center'>Already have and account ? <Link className='text-base font-medium text-indigo-600' to='/login'>Please login</Link></p>
                    <div className="form-control mt-6">
